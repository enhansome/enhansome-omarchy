...
* [Omarchy](https://github.com/basecamp/omarchy) ⭐ 42,991 | 🐛 4,491 | 🌐 Shell | 📅 2026-09-24 - The main Omarchy project by Basecamp.
...
* [hyprwhspr](https://github.com/goodroot/hyprwhspr) ⭐ 1,217 | 🐛 3 | 🌐 Python | 📅 2026-09-17 - Native speech-to-text for Arch / Omarchy. Fast, accurate and easy system-wide Whisper dictation.
* [omarchy-nix](https://github.com/henrysipp/omarchy-nix) ⭐ 806 | 🐛 5 | 🌐 Nix | 📅 2025-11-13 - NixOS version of Omarchy with declarative configuration.
* [omarchy-on-cachyos](https://github.com/mroboff/omarchy-on-cachyos) ⭐ 668 | 🐛 34 | 🌐 Shell | 📅 2026-06-01 - Installation script for Omarchy on top of CachyOS.
...
* [Okimarchy](https://github.com/cristian-fleischer/okimarchy) ⭐ 126 | 🐛 3 | 🌐 Shell | 📅 2026-09-24 - An Omarchy fork that adds support for niri window manager alongside Hyprland, with runtime switching and unified theming.
...
Community plugins for [Omarchy Quattro](https://github.com/basecamp/omarchy/tree/quattro) ⭐ 42,991 | 🐛 4,491 | 🌐 Shell | 📅 2026-09-24.

* [AI Usage](https://github.com/akitaonrails/ai-usagebar) ⭐ 561 | 🐛 8 | 🌐 Rust | 📅 2026-09-24 - Multi-provider AI plan usage and balances in a native Omarchy Quattro panel.
* [Omamail](https://github.com/huacnlee/omamail) ⭐ 256 | 🐛 60 | 🌐 QML | 📅 2026-09-21 - Native Gmail and IMAP client for Omarchy.
* [Omarchy Spotify](https://github.com/stappmus/Omarchy-Spotify) ⭐ 215 | 🐛 60 | 🌐 QML | 📅 2026-09-13 - Native Quickshell Spotify client themed for Omarchy.
* [AirPods](https://github.com/thisisgm/omarchy-pods) ⭐ 213 | 🐛 22 | 🌐 C++ | 📅 2026-08-26 - Battery, listening mode, and noise-control widgets for connected AirPods.
...
* [Lock Screen Explorer](https://github.com/SirJul1337/omarchy-lock-explorer) ⭐ 179 | 🐛 2 | 🌐 QML | 📅 2026-09-23 - Lock screen designs for Omarchy with a picker to preview and switch between them.
...
* [Omaland](https://github.com/bobby-nicholas/omaland) ⭐ 51 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-17 - Live-preview panel for editing Hyprland look-and-feel from the Omarchy menu.
* [Omagen](https://github.com/prettyletto/omagen) ⭐ 47 | 🐛 1 | 🌐 QML | 📅 2026-09-14 - Generate Omarchy themes from images.
* [Dock](https://github.com/rosakodu/omarchy-dock) ⭐ 44 | 🐛 14 | 🌐 QML | 📅 2026-09-24 - Animated application dock for Omarchy Quattro with Hyprland window tracking.
...
* [Calendar](https://github.com/tmn73/omarchy-calendar) ⭐ 39 | 🐛 17 | 🌐 QML | 📅 2026-09-08 - Next Google Calendar event in the Omarchy bar with one-click meeting join.
...
* [Mirador](https://github.com/sanjyay/Mirador) ⭐ 34 | 🐛 3 | 🌐 QML | 📅 2026-09-24 - Visual overview of workspaces and their windows.
...
* [OmaConnect](https://github.com/jitendradara12/omaconnect) ⭐ 32 | 🐛 1 | 🌐 QML | 📅 2026-09-21 - KDE Connect integration for SMS, clipboard, file sharing, and device commands.
...
* [Calendar Sync Clock](https://github.com/promaaa/sync-calendar-omarchy) ⭐ 19 | 🐛 1 | 🌐 Python | 📅 2026-09-24 - Clock and calendar for the Omarchy bar with two-way sync for Google, iCloud, Proton, Outlook, Fastmail JMAP, Nextcloud, and any iCalendar feed.
...
* [hyprmarker](https://github.com/devmobasa/hyprmarker) ⭐ 747 | 🐛 1 | 🌐 Rust | 📅 2026-09-22 - ZoomIt-inspired annotation overlay tailored for Hyprland/Omarchy.
* [wayscriber](https://github.com/devmobasa/wayscriber) ⭐ 747 | 🐛 1 | 🌐 Rust | 📅 2026-09-22 - Instant on-screen annotations and markup for Wayland, ZoomIt-inspired.
* [aether](https://github.com/bjarneo/aether) ⭐ 724 | 🐛 5 | 🌐 Go | 📅 2026-09-20 - Desktop theming toolkit that streamlines crafting Omarchy themes.
* [waybar-themes](https://github.com/HANCORE-linux/waybar-themes) ⭐ 626 | 🐛 0 | 🌐 CSS | 📅 2026-06-19 - Collection of Waybar themes with various styles and combinations for Omarchy.
...
* [omarchy-iso](https://github.com/omacom-io/omarchy-iso) ⭐ 285 | 🐛 67 | 🌐 Shell | 📅 2026-09-24 - Custom ISO builder for Omarchy installations.
...
* [renCal](https://github.com/t4t5/rencal) ⭐ 147 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-23 - Modern desktop calendar built for Omarchy that syncs with Google, iCloud, Outlook and CalDAV.
* [flutter\_omarchy](https://github.com/aloisdeniel/flutter_omarchy) ⭐ 129 | 🐛 0 | 🌐 Dart | 📅 2026-08-14 - Develop Flutter apps for Omarchy.
* [omarchy-pkgs](https://github.com/omacom-io/omarchy-pkgs) ⭐ 122 | 🐛 215 | 🌐 Shell | 📅 2026-09-24 - Official Omarchy packages and utilities.
...
* [lazyVPN-for-Omarchy](https://github.com/blank-query/lazyVPN-for-Omarchy) ⭐ 33 | 🐛 0 | 🌐 Go | 📅 2026-09-23 - A WireGuard VPN manager with Walker menu integration, killswitch protection, and dynamic server browsing.
...
* [omacal](https://github.com/x3me/omacal) ⭐ 27 | 🐛 4 | 🌐 Rust | 📅 2026-09-24 - Desktop calendar for Google, iCloud and CalDAV with live Omarchy theming, a bar widget, and a CLI for terminals and agents.
...
* [Hyprflip](https://github.com/nocstah/hyprflip) ⭐ 7 | 🐛 2 | 🌐 Python | 📅 2026-09-23 - Hyprland plugin for two-sided window cards with animated flipping, multi-app faces, and saved workspace arrangements.
...
* [dougburks/ohmydebn](https://github.com/dougburks/ohmydebn) ⭐ 143 | 🐛 15 | 🌐 Shell | 📅 2026-09-22 - A debonair Debian + Cinnamon setup inspired by Omarchy.
* [omarchy-site](https://github.com/omacom-io/omarchy-site) ⭐ 122 | 🐛 258 | 🌐 HTML | 📅 2026-09-24 - Official Omarchy website source code.
...
* [omarchy-plugin-marketplace](https://github.com/HANCORE-linux/omarchy-plugin-marketplace) ⭐ 303 | 🐛 915 | 🌐 JavaScript | 📅 2026-09-24 - Community registry of Omarchy Quattro plugins, published at omarchyplugins.com.
...
* [GitHub Discussions](https://github.com/basecamp/omarchy/discussions) ⭐ 42,991 | 🐛 4,491 | 🌐 Shell | 📅 2026-09-24 - Official community discussions and support.
* [GitHub Issues](https://github.com/basecamp/omarchy/issues) ⭐ 42,991 | 🐛 4,491 | 🌐 Shell | 📅 2026-09-24 - Bug reports and feature requests.
* [Omarchy on Raspberry Pi 5](https://github.com/basecamp/omarchy/discussions/642) ⭐ 42,991 | 🐛 4,491 | 🌐 Shell | 📅 2026-09-24 - Community discussion on running Omarchy on Raspberry Pi 5.
...
* [omarchy-blackturq-theme](https://github.com/HANCORE-linux/omarchy-blackturq-theme) ⭐ 55 | 🐛 0 | 🌐 CSS | 📅 2026-08-04 - Black turquoise theme based on Evo80 keyboard color pattern.
...
* [omarchy-crimson-gold-theme](https://github.com/knappkevin/omarchy-crimson-gold-theme) ⭐ 9 | 🐛 0 | 🌐 CSS | 📅 2026-09-13 - Luxurious crimson and gold color combination.
