...
* [Omarchy](https://github.com/basecamp/omarchy) ⭐ 42,839 | 🐛 4,395 | 🌐 Shell | 📅 2026-09-23 - The main Omarchy project by Basecamp.
...
* [hyprwhspr](https://github.com/goodroot/hyprwhspr) ⭐ 1,213 | 🐛 3 | 🌐 Python | 📅 2026-09-17 - Native speech-to-text for Arch / Omarchy. Fast, accurate and easy system-wide Whisper dictation.
* [omarchy-nix](https://github.com/henrysipp/omarchy-nix) ⭐ 803 | 🐛 5 | 🌐 Nix | 📅 2025-11-13 - NixOS version of Omarchy with declarative configuration.
* [omarchy-on-cachyos](https://github.com/mroboff/omarchy-on-cachyos) ⭐ 666 | 🐛 34 | 🌐 Shell | 📅 2026-06-01 - Installation script for Omarchy on top of CachyOS.
...
* [omarchy-hub](https://github.com/deepakness/omarchy-hub) ⭐ 37 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - A comprehensive resource library for Omarchy Linux.
...
Community plugins for [Omarchy Quattro](https://github.com/basecamp/omarchy/tree/quattro) ⭐ 42,839 | 🐛 4,395 | 🌐 Shell | 📅 2026-09-23.

* [AI Usage](https://github.com/akitaonrails/ai-usagebar) ⭐ 546 | 🐛 3 | 🌐 Rust | 📅 2026-09-23 - Multi-provider AI plan usage and balances in a native Omarchy Quattro panel.
* [Omamail](https://github.com/huacnlee/omamail) ⭐ 256 | 🐛 52 | 🌐 QML | 📅 2026-09-21 - Native Gmail and IMAP client for Omarchy.
* [Omarchy Spotify](https://github.com/stappmus/Omarchy-Spotify) ⭐ 215 | 🐛 58 | 🌐 QML | 📅 2026-09-13 - Native Quickshell Spotify client themed for Omarchy.
...
* [SHIBUMI](https://github.com/HANCORE-linux/Shibumi-Shell) ⭐ 195 | 🐛 7 | 🌐 QML | 📅 2026-09-21 - Native bar and modular plugin suite for Omarchy Quattro.
* [Lock Screen Explorer](https://github.com/SirJul1337/omarchy-lock-explorer) ⭐ 169 | 🐛 3 | 🌐 QML | 📅 2026-09-23 - Lock screen designs for Omarchy with a picker to preview and switch between them.
...
* [hyprmoncfg](https://github.com/crmne/omarchy-hyprmoncfg) ⭐ 100 | 🐛 1 | 🌐 QML | 📅 2026-09-23 - Automatic Hyprland monitor profiles on hotplug, lid events, and resume.
* [omaplug](https://github.com/fross100/omaplug) ⭐ 67 | 🐛 2 | 🌐 QML | 📅 2026-09-23 - Standalone manager to enable, update, install, and remove Omarchy plugins.
...
* [GitHub](https://github.com/robzolkos/omarchy-github) ⭐ 59 | 🐛 2 | 🌐 Shell | 📅 2026-09-16 - Keyboard-friendly GitHub inbox for notifications, reviews, PRs, and Actions.
* [Claude Usage](https://github.com/mryll/claudebar) ⭐ 58 | 🐛 0 | 🌐 Shell | 📅 2026-09-16 - Claude Code session, weekly, and per-model usage limits in the Omarchy bar.
...
* [Omaland](https://github.com/bobby-nicholas/omaland) ⭐ 50 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-17 - Live-preview panel for editing Hyprland look-and-feel from the Omarchy menu.
* [Omagen](https://github.com/prettyletto/omagen) ⭐ 47 | 🐛 1 | 🌐 QML | 📅 2026-09-14 - Generate Omarchy themes from images.
* [Dock](https://github.com/rosakodu/omarchy-dock) ⭐ 44 | 🐛 18 | 🌐 QML | 📅 2026-09-11 - Animated application dock for Omarchy Quattro with Hyprland window tracking.
...
* [Calendar](https://github.com/tmn73/omarchy-calendar) ⭐ 38 | 🐛 18 | 🌐 QML | 📅 2026-09-08 - Next Google Calendar event in the Omarchy bar with one-click meeting join.
...
* [Screen Time](https://github.com/ax1g/quickshell-screentime-plugin) ⭐ 35 | 🐛 2 | 🌐 QML | 📅 2026-09-21 - Per-app screen time in the Omarchy bar with local history and trends.
* [Mirador](https://github.com/sanjyay/Mirador) ⭐ 34 | 🐛 3 | 🌐 QML | 📅 2026-09-23 - Visual overview of workspaces and their windows.
...
* [Sandman](https://github.com/lgse/sandman) ⭐ 23 | 🐛 1 | 🌐 QML | 📅 2026-09-23 - Lid-close, lock, sleep, and hibernate timing controls for Omarchy.
* [Calendar Sync Clock](https://github.com/promaaa/sync-calendar-omarchy) ⭐ 19 | 🐛 12 | 🌐 Python | 📅 2026-09-23 - Clock and calendar for the Omarchy bar with two-way sync for Google, iCloud, Proton, Outlook, Fastmail JMAP, Nextcloud, and any iCalendar feed.
...
* [aether](https://github.com/bjarneo/aether) ⭐ 723 | 🐛 4 | 🌐 Go | 📅 2026-09-20 - Desktop theming toolkit that streamlines crafting Omarchy themes.
...
* [omarchy-iso](https://github.com/omacom-io/omarchy-iso) ⭐ 286 | 🐛 67 | 🌐 Shell | 📅 2026-09-22 - Custom ISO builder for Omarchy installations.
...
* [renCal](https://github.com/t4t5/rencal) ⭐ 146 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-23 - Modern desktop calendar built for Omarchy that syncs with Google, iCloud, Outlook and CalDAV.
* [flutter\_omarchy](https://github.com/aloisdeniel/flutter_omarchy) ⭐ 129 | 🐛 0 | 🌐 Dart | 📅 2026-08-14 - Develop Flutter apps for Omarchy.
* [omarchy-pkgs](https://github.com/omacom-io/omarchy-pkgs) ⭐ 122 | 🐛 207 | 🌐 Shell | 📅 2026-09-23 - Official Omarchy packages and utilities.
...
* [omacal](https://github.com/x3me/omacal) ⭐ 27 | 🐛 3 | 🌐 Rust | 📅 2026-09-23 - Desktop calendar for Google, iCloud and CalDAV with live Omarchy theming, a bar widget, and a CLI for terminals and agents.
...
* [Hyprflip](https://github.com/nocstah/hyprflip) ⭐ 6 | 🐛 2 | 🌐 Python | 📅 2026-09-23 - Hyprland plugin for two-sided window cards with animated flipping, multi-app faces, and saved workspace arrangements.
...
* [dougburks/ohmydebn](https://github.com/dougburks/ohmydebn) ⭐ 142 | 🐛 15 | 🌐 Shell | 📅 2026-09-22 - A debonair Debian + Cinnamon setup inspired by Omarchy.
* [omarchy-site](https://github.com/omacom-io/omarchy-site) ⭐ 119 | 🐛 256 | 🌐 HTML | 📅 2026-09-23 - Official Omarchy website source code.
...
* [omarchy-plugin-marketplace](https://github.com/HANCORE-linux/omarchy-plugin-marketplace) ⭐ 300 | 🐛 878 | 🌐 JavaScript | 📅 2026-09-23 - Community registry of Omarchy Quattro plugins, published at omarchyplugins.com.
...
* [GitHub Discussions](https://github.com/basecamp/omarchy/discussions) ⭐ 42,839 | 🐛 4,395 | 🌐 Shell | 📅 2026-09-23 - Official community discussions and support.
* [GitHub Issues](https://github.com/basecamp/omarchy/issues) ⭐ 42,839 | 🐛 4,395 | 🌐 Shell | 📅 2026-09-23 - Bug reports and feature requests.
* [Omarchy on Raspberry Pi 5](https://github.com/basecamp/omarchy/discussions/642) ⭐ 42,839 | 🐛 4,395 | 🌐 Shell | 📅 2026-09-23 - Community discussion on running Omarchy on Raspberry Pi 5.
...
* [omarchy-akane-theme](https://github.com/Grenish/omarchy-akane-theme) ⭐ 112 | 🐛 0 | 🌐 Lua | 📅 2026-08-31 - Akane theme with Japanese-inspired colors.
* [aetheria](https://github.com/JJDizz1L/aetheria) ⭐ 109 | 🐛 1 | 🌐 CSS | 📅 2026-08-17 - Ethereal and modern theme with balanced aesthetics.
...
* [omarchy-snow-theme](https://github.com/bjarneo/omarchy-snow-theme) ⭐ 17 | 🐛 3 | 📅 2026-08-30 - Snow theme with clean winter-inspired aesthetics.
...
* [omarchy-outpost-theme](https://github.com/simoz/omarchy-outpost-theme) ⭐ 9 | 🐛 0 | 📅 2026-09-17 - Dark theme with petroleum, bronze, and ivory colors and robot-inspired pixel art wallpapers.
