...
* [Omarchy](https://github.com/basecamp/omarchy) ⭐ 36,101 | 🐛 2,465 | 🌐 Shell | 📅 2026-08-31 - The main Omarchy project by Basecamp.
...
* [hyprwhspr](https://github.com/goodroot/hyprwhspr) ⭐ 1,182 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - Native speech-to-text for Arch / Omarchy. Fast, accurate and easy system-wide Whisper dictation.
* [omarchy-nix](https://github.com/henrysipp/omarchy-nix) ⭐ 779 | 🐛 5 | 🌐 Nix | 📅 2025-11-13 - NixOS version of Omarchy with declarative configuration.
* [omarchy-on-cachyos](https://github.com/mroboff/omarchy-on-cachyos) ⭐ 637 | 🐛 31 | 🌐 Shell | 📅 2026-06-01 - Installation script for Omarchy on top of CachyOS.
...
* [deckarchy](https://github.com/aorumbayev/deckarchy) ⭐ 46 | 🐛 1 | 🌐 Shell | 📅 2025-08-19 - Steam Deck hardware fixes and optimizations for Omarchy installation.
* [omarchy-hub](https://github.com/deepakness/omarchy-hub) ⭐ 33 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-31 - A comprehensive resource library for Omarchy Linux.
...
Community plugins for [Omarchy Quattro](https://github.com/basecamp/omarchy/tree/quattro) ⭐ 36,101 | 🐛 2,465 | 🌐 Shell | 📅 2026-08-31.

* [AI Usage](https://github.com/akitaonrails/ai-usagebar) ⭐ 386 | 🐛 1 | 🌐 Rust | 📅 2026-08-30 - Multi-provider AI plan usage and balances in a native Omarchy Quattro panel.
* [AirPods](https://github.com/thisisgm/omarchy-pods) ⭐ 160 | 🐛 5 | 🌐 C++ | 📅 2026-08-26 - Battery, listening mode, and noise-control widgets for connected AirPods.
* [Omarchy Spotify](https://github.com/stappmus/Omarchy-Spotify) ⭐ 148 | 🐛 15 | 🌐 QML | 📅 2026-08-31 - Native Quickshell Spotify client themed for Omarchy.
* [Omamail](https://github.com/huacnlee/omamail) ⭐ 120 | 🐛 22 | 🌐 JavaScript | 📅 2026-08-31 - Native Gmail and IMAP client for Omarchy.
* [SHIBUMI](https://github.com/HANCORE-linux/Shibumi-Shell) ⭐ 117 | 🐛 10 | 🌐 QML | 📅 2026-08-24 - Native bar and modular plugin suite for Omarchy Quattro.
...
* [Lock Screen Explorer](https://github.com/SirJul1337/omarchy-lock-explorer) ⭐ 99 | 🐛 1 | 🌐 QML | 📅 2026-08-30 - Lock screen designs for Omarchy with a picker to preview and switch between them.
* [hyprmoncfg](https://github.com/crmne/omarchy-hyprmoncfg) ⭐ 64 | 🐛 4 | 🌐 QML | 📅 2026-08-31 - Automatic Hyprland monitor profiles on hotplug, lid events, and resume.
* [Okomart](https://github.com/brianblakely/omarchy-plugins) ⭐ 55 | 🐛 9 | 🌐 Shell | 📅 2026-08-25 - Storefront to browse, install, update, and remove Omarchy plugins.
* [Claude Usage](https://github.com/mryll/claudebar) ⭐ 49 | 🐛 1 | 🌐 Shell | 📅 2026-08-27 - Claude Code session, weekly, and per-model usage limits in the Omarchy bar.
* [Mihomo](https://github.com/lijiawei0305-pixel/omarchy-mihomo-plugin) ⭐ 49 | 🐛 0 | 🌐 QML | 📅 2026-08-22 - Status-bar control panel for a standalone mihomo proxy core.
* [GitHub](https://github.com/robzolkos/omarchy-github) ⭐ 44 | 🐛 0 | 🌐 QML | 📅 2026-08-26 - Keyboard-friendly GitHub inbox for notifications, reviews, PRs, and Actions.
* [Prayer Times](https://github.com/husamemadH/omarchy-quattro-prayer-times) ⭐ 34 | 🐛 0 | 🌐 QML | 📅 2026-08-31 - Next prayer countdown and today's prayer times in the Omarchy bar.
* [Omaland](https://github.com/bobby-nicholas/omaland) ⭐ 33 | 🐛 1 | 🌐 QML | 📅 2026-08-18 - Live-preview panel for editing Hyprland look-and-feel from the Omarchy menu.
* [omaplug](https://github.com/fross100/omaplug) ⭐ 31 | 🐛 0 | 🌐 QML | 📅 2026-08-26 - Standalone manager to enable, update, install, and remove Omarchy plugins.
* [Activity Monitor](https://github.com/stappmus/omarchy-activity-monitor) ⭐ 29 | 🐛 2 | 🌐 Shell | 📅 2026-08-31 - Lightweight CPU, memory, GPU, storage, and process glance for Omarchy Quattro.
...
* [Home Assistant](https://github.com/konradk/hass) ⭐ 26 | 🐛 5 | 🌐 QML | 📅 2026-08-17 - View and control Home Assistant devices from the Omarchy bar.
...
* [Calendar](https://github.com/tmn73/omarchy-calendar) ⭐ 24 | 🐛 6 | 🌐 QML | 📅 2026-08-14 - Next Google Calendar event in the Omarchy bar with one-click meeting join.
...
* [Dock](https://github.com/rosakodu/omarchy-dock) ⭐ 23 | 🐛 2 | 🌐 QML | 📅 2026-08-30 - Animated application dock for Omarchy Quattro with Hyprland window tracking.
* [Mirador](https://github.com/sanjyay/Mirador) ⭐ 22 | 🐛 1 | 🌐 QML | 📅 2026-08-31 - Visual overview of workspaces and their windows.
* [Omagen](https://github.com/prettyletto/omagen) ⭐ 22 | 🐛 0 | 🌐 Go | 📅 2026-08-31 - Generate Omarchy themes from images.
* [Screen Time](https://github.com/ax1g/quickshell-screentime-plugin) ⭐ 22 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-26 - Per-app screen time in the Omarchy bar with local history and trends.
...
* [Omalibre](https://github.com/AlexZeitler/omalibre) ⭐ 21 | 🐛 1 | 🌐 Rust | 📅 2026-08-23 - Bookshelf plugin for recently read books on Omarchy.
...
* [hyprmarker](https://github.com/devmobasa/hyprmarker) ⭐ 722 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 - ZoomIt-inspired annotation overlay tailored for Hyprland/Omarchy.
* [wayscriber](https://github.com/devmobasa/wayscriber) ⭐ 722 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 - Instant on-screen annotations and markup for Wayland, ZoomIt-inspired.
* [omarchist](https://github.com/tahayvr/omarchist) ⭐ 719 | 🐛 1 | 🌐 Rust | 📅 2026-04-22 - GUI app for Omarchy with visual theme designer built with Tauri/Rust/Svelte.
* [aether](https://github.com/bjarneo/aether) ⭐ 668 | 🐛 9 | 🌐 Go | 📅 2026-08-30 - Desktop theming toolkit that streamlines crafting Omarchy themes.
* [waybar-themes](https://github.com/HANCORE-linux/waybar-themes) ⭐ 606 | 🐛 0 | 🌐 CSS | 📅 2026-06-19 - Collection of Waybar themes with various styles and combinations for Omarchy.
...
* [omarchy-cleaner](https://github.com/maxart/omarchy-cleaner) ⭐ 289 | 🐛 1 | 🌐 Shell | 📅 2026-05-29 - Quickly and easily remove pre-installed apps and webapps.
* [omarchy-iso](https://github.com/omacom-io/omarchy-iso) ⭐ 248 | 🐛 30 | 🌐 Shell | 📅 2026-08-30 - Custom ISO builder for Omarchy installations.
...
* [omarchy-pkgs](https://github.com/omacom-io/omarchy-pkgs) ⭐ 81 | 🐛 65 | 🌐 Shell | 📅 2026-08-31 - Official Omarchy packages and utilities.
...
* [omacal](https://github.com/x3me/omacal) ⭐ 11 | 🐛 5 | 🌐 Rust | 📅 2026-08-31 - Desktop calendar for Google, iCloud and CalDAV with live Omarchy theming, a bar widget, and a CLI for terminals and agents.
...
* [omarchy-site](https://github.com/omacom-io/omarchy-site) ⭐ 32 | 🐛 63 | 🌐 HTML | 📅 2026-08-31 - Official Omarchy website source code.
...
* [omarchy-plugin-marketplace](https://github.com/HANCORE-linux/omarchy-plugin-marketplace) ⭐ 200 | 🐛 626 | 🌐 JavaScript | 📅 2026-08-31 - Community registry of Omarchy Quattro plugins, published at omarchyplugins.com.
...
* [GitHub Discussions](https://github.com/basecamp/omarchy/discussions) ⭐ 36,101 | 🐛 2,465 | 🌐 Shell | 📅 2026-08-31 - Official community discussions and support.
* [GitHub Issues](https://github.com/basecamp/omarchy/issues) ⭐ 36,101 | 🐛 2,465 | 🌐 Shell | 📅 2026-08-31 - Bug reports and feature requests.
* [Omarchy on Raspberry Pi 5](https://github.com/basecamp/omarchy/discussions/642) ⭐ 36,101 | 🐛 2,465 | 🌐 Shell | 📅 2026-08-31 - Community discussion on running Omarchy on Raspberry Pi 5.
...
* [omarchy-akane-theme](https://github.com/Grenish/omarchy-akane-theme) ⭐ 71 | 🐛 0 | 🌐 Lua | 📅 2026-08-31 - Akane theme with Japanese-inspired colors.
...
* [omarchy-matte-black](https://github.com/tahayvr/omarchy-matte-black) ⭐ 54 | 🐛 0 | 🌐 CSS | 📅 2026-01-31 - Sleek matte black theme for minimalists.
...
* [omarchy-ash-theme](https://github.com/bjarneo/omarchy-ash-theme) ⭐ 49 | 🐛 2 | 📅 2026-08-30 - Subtle ash-gray color scheme.
...
* [omarchy-blackgold-theme](https://github.com/HANCORE-linux/omarchy-blackgold-theme) ⭐ 42 | 🐛 0 | 🌐 CSS | 📅 2026-08-04 - Sleek black-and-gold theme with luxurious aesthetics.
...
* [omarchy-moodpeak-theme](https://github.com/HANCORE-linux/omarchy-moodpeak-theme) ⭐ 20 | 🐛 0 | 🌐 CSS | 📅 2026-08-05 - Mood-lifting theme designed to pull you back to peak focus.
